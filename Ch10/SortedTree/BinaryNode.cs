    ...
    public class BinaryNode
    {
        ...
        public void AddNode(int value)
        {
            ...
            if (value < Value)
            {
                ...
                if (LeftChild == null) LeftChild = new BinaryNode(value);
                else LeftChild.AddNode(value);
            }
            else
            {
                // The new value is not smaller. Add it to the right subtree.
                if (RightChild == null) RightChild = new BinaryNode(value);
        ...
        public void DrawSubtreeNodes(Graphics gr, Font font, Brush fgBrush, Brush bgBrush, Pen pen)
        {
            ...
            using (StringFormat format = new StringFormat())
            {
                ...
                gr.DrawString(Value.ToString(), font, fgBrush, NodeRect, format);
            }
