...
namespace SortedChaining
{
    public partial class Form1 : Form
    {
        ...
        private int AddItem(int key, out int index)
        {
            ...
            Cell cell = bucket;
            int probes = 0;
            while ((cell.Next != null) && (cell.Next.Value < key))
            {
                cell = cell.Next;
                probes++;
            }
            ...
            if ((cell.Next != null) && (cell.Next.Value == key))
                throw new ArgumentException(
                    "This key is already in the hash table. Bucket: " +
                    index);

            // Add the item at this position.
            Cell newCell = new Cell(key, cell.Next);
            cell.Next = newCell;
        ...
        private int FindItem(int key, out Cell cell)
        {
            ...
            cell = bucket.Next;
            int probes = 1;
            while ((cell != null) && (cell.Value < key))
            {
                cell = cell.Next;
                probes++;
            }
            ...
            if ((cell != null) && (cell.Value > key)) cell = null;
            return probes;
        }
